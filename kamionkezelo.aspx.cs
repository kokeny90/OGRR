...
public partial class kamionkezelo : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            azonosito = int.Parse(Feltoltes("SELECT  dbo.Kamionkezelo.Azonosito AS Expr1 FROM dbo.Kamionkezelo INNER JOIN dbo.rendszamok ON dbo.Kamionkezelo.vontatorendszam = dbo.rendszamok.id WHERE (dbo.rendszamok.rendszam = @bemenoadat) AND (dbo.Kamionkezelo.befele = 1) ORDER BY Expr1 DESC", "insert into  dbo.Users(Nev) values(@bemenoadat);", TextBoxVontatoRendszam.Text.Trim()));
            irany = 0;
        }
    ...
    protected void TextBoxFovalalkozo_TextChanged(object sender, EventArgs e)
    {
