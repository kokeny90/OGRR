<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Start.aspx.cs" Inherits="Start" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table class="styletable">
                ...
                <tr>
                    ...
                    <td class="bevitelimezocella" style="height: 30px">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorLokacio3" runat="server" ControlToValidate="DropDownListLokacio" ErrorMessage="Kérlek válassz egyet!" InitialValue="-1" CssClass="hibaoszlop" ></asp:RequiredFieldValidator>           
                    </td>
    ...
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Adatok Felvétele"  Style="height: 26px" />
    ...
    <div>
        ...
        <br />
        <asp:Button ID="btnExportWord" runat="server" Text="ExportToWord" OnClick="btnExportWord_Click"  CausesValidation="False" Visible="False" />
        &nbsp;
        <asp:Button ID="btnExportExcel" runat="server" Text="ExportToExcel" OnClick="btnExportExcel_Click"  CausesValidation="False" Visible="False" />
        &nbsp;
        <asp:Button ID="btnExportPDF" runat="server" Text="ExportToPDF" OnClick="btnExportPDF_Click"  CausesValidation="False" Visible="False" />
         &nbsp;
        <asp:Button ID="Button4" runat="server" Text="ExportToCSV" OnClick="btnExportCSV_Click"  CausesValidation="False" Visible="False" />
           <br />   <br />
            ...
            <ContentTemplate>
                <asp:GridView OnRowDeleting="OnRowDeleting"  ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound"  DataSourceID="Tábla">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ÉRKEZÉS DÁTUMA" HeaderText="ÉRKEZÉS DÁTUMA" SortExpression="ÉRKEZÉS DÁTUMA"  />
...
(Fővállalkozó)" />
                       ...
                       <asp:BoundField DataField="SZÁLLÍTÓLEVÉL / CMR(BEFELÉ)" HeaderText="SZÁLLÍTÓLEVÉL / CMR(BEFELÉ)" SortExpression="SZÁLLÍTÓLEVÉL / CMR(BEFELÉ)" />
                        ...
                        <asp:CheckBoxField DataField="torolve" HeaderText="torolve" SortExpression="torolve" Visible="true" />
